          ...
          <ul class="apps-list vertical" height="auto">
            ...
            <li>
              <div>
                ...
                <motion.div animate={controlTitleText}>Planner</motion.div>
              </div>
            </li>
            ...
            <li>
              <div>
                ...
                <motion.div animate={controlTitleText}>Orders</motion.div>
              </div>
            </li>
            <li>
              <div>
                ...
                <motion.div animate={controlTitleText}>Fleet</motion.div>
              </div>
            </li>
          </ul>
          ...
          <ul class="general-list vertical" height="auto">
            ...
            <li>
              <div>
                ...
                <motion.div animate={controlTitleText}>My adresses</motion.div>
              </div>
            </li>
            ...
            <li>
              <div>
                ...
                <motion.div animate={controlTitleText}>Profile</motion.div>
              </div>
            </li>
            <li>
              <div>
                ...
                <motion.div animate={controlTitleText}>Ustawienia</motion.div>
              </div>
            </li>
          </ul>
